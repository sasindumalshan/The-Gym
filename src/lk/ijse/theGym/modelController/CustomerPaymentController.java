...
public class CustomerPaymentController {
    ...
    public static String getFinalTotal(String date) throws SQLException, ClassNotFoundException {
        return setString(CrudUtil.crudUtil("SELECT SUM(monthly_fees) FROM customer_payment WHERE date=?", date));
    }
